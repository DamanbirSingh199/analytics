...
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) #Items atleast bought together 100 times, minimum bought together 2 times, maximum 5 bought together
...
abline(h=0.15)#Will show items bought more than 15% times
...
#RHS would always have one item, can have multiple on the LHS
